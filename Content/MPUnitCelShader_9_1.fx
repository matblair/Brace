...
float4 PS( PS_IN input ) : SV_Target
{
	...
	float4 sunlightPntCol = float4(sun.r, sun.g, sun.b, 1.0);
	float Ka = sun.Ka; // Very little ambient light generated by the lamp.
	float3 amb = input.col.rgb*sunlightPntCol.rgb*Ka;
